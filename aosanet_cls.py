...
class get_model(nn.Module):
    def __init__(self,num_class,normal_channel=True):
        ...
        self.sa2 = PointNetSetAbstraction(npoint=128, radius=0.4, nsample=64, in_channel=128 + 3, mlp=[128, 256], group_all=False)
        self.sa3 = PointNetSetAbstraction(npoint=None, radius=None, nsample=None, in_channel=256 + 3, mlp=[512, 1024], group_all=True)
    ...
    def forward(self, xyz):
        ...
        if self.normal_channel:
            ...
            norm = None
        l1_xyz, l1_points = self.sa1(xyz, norm)  #2,3,512,    2,128.512
        l2_xyz, l2_points = self.sa2(l1_xyz, l1_points)  #2，3，256   2，256，256
        l3_xyz, l3_points = self.sa3(l2_xyz, l2_points)  #2，3，128  2，512，128
        #x1=torch.mean(l3_points,2)  #2,1024
        x = torch.max(l3_points, 2)[0]  # 2，1024  #max
        #x=x1+x2  #2,1024
        #x = x.view(B, 1024)
